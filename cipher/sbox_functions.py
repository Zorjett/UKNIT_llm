...
class sbox_functions:
    ...
    @staticmethod
    def _randomize_good_sbox(sbox):
        """Randomize a good initial S-box; search-time changes use LLM actions."""
        chosen_function = np.random.choice(
            ['AFFINE', 'LINEAR', 'BITPERM', 'SWAP_ENTRIES']
        )
    ...
    def get_good_sbox():
        while True:
            ...
            sbox = sbox_functions._randomize_good_sbox(sbox)
