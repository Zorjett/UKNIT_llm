    ...
    def _call(
        ...
        *,
        ...
        try:
            ...
            # Performance is a required scientific measurement.  Never turn an
            # OpenLane failure into an ``unavailable`` placeholder: callers must
            # stop the run instead of computing fitness from fake latency.
